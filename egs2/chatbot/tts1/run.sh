...
#     --train_args "--init_param /home/espnet/egs2/chatbot/tts1/pretrained/exp/tts_train_raw_phn_pypinyin_g2p_phone/245epoch.pth:tts:tts" \
#     --tag finetune_tacotron2_raw_phn_chatbot_g2pw \
#     ${opts} "$@"
...
./tts.sh \
    ...
    --train_config conf/tuning/train_gst+xvector_conformer_fastspeech2_.yaml  \
    ...
    --tag tts_finetune_fastpeech2_g2pw \
    ${opts} "$@"
